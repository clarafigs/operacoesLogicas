...
public class ImageXorOperation {
    ...
    public static void main(String[] args) {
        try {
            ...
            BufferedImage resultImage = xorImages(resizedImage1, resizedImage2);

            ImageIO.write(resultImage, "jpg", new File("imagensOP/xor9_10.jpg"));

            System.out.println("Operação lógica XOR concluída com sucesso!");
    ...
    public static BufferedImage xorImages(BufferedImage img1, BufferedImage img2) {
