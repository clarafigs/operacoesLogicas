...
public class ImageAndOperation {
    ...
    public static void main(String[] args) {
        try {
            ...
            BufferedImage resultImage = andImages(resizedImage1, resizedImage2);

            ImageIO.write(resultImage, "jpg", new File("imagensOP/and9_10.jpg"));

            System.out.println("Operação lógica AND concluída com sucesso!");
    ...
    public static BufferedImage andImages(BufferedImage img1, BufferedImage img2) {
        ...
        for (int x = 0; x < width; x++) {
            for (int y = 0; y < height; y++) {
                ...
                int pixelResult = (pixel1 > 0 && pixel2 > 0) ? 255 : 0;
