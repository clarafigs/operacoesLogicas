...
public class ImageOrOperation {
    ...
    public static void main(String[] args) {
        try {
            ...
            BufferedImage resultImage = orImages(resizedImage1, resizedImage2);

            ImageIO.write(resultImage, "jpg", new File("imagensOP/or9_10.jpg"));

            System.out.println("Operação lógica OR concluída com sucesso!");
    ...
    public static BufferedImage orImages(BufferedImage img1, BufferedImage img2) {
        ...
        for (int x = 0; x < width; x++) {
            for (int y = 0; y < height; y++) {
                ...
                int pixelResult = Math.min(255, pixel1 | pixel2);
